...
import (
	...
	"icode.baidu.com/baidu/nxt-sim/sim-exporter/pkg/client/clientset/versioned/scheme"
...
func (c *KubeflowV1Client) SimJobs(namespace string) SimJobInterface {
	return newSimJobs(c, namespace)
}
